...
import { Formulario } from "../componentes/titulos/Formulario";
import { Buscador } from "../componentes/titulos/Buscador";
import { Resultados } from "../componentes/titulos/Resultados";

export const Titulos = () => {
	const datatable = new Conexion();
	const Tabla = "parametrostabla";
